...
telemetry_logging_enabled: bool = True


logging.config.dictConfig(get_log_config(log_level, telemetry_logging_enabled))

telemetry_config = TelemetryConfig(
    tracing=TracingConfig(
        otlp_export=otlp_export_enabled, logging=telemetry_logging_enabled
    ),
)
