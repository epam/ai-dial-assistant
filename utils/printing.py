...
def print_warning(msg: str):
    print(Fore.YELLOW + msg + Style.RESET_ALL, flush=True)
...
def print_system(msg: str):
    print(Back.LIGHTBLACK_EX + msg + Style.RESET_ALL, flush=True)


def print_human(msg: str):
...
def print_lsp(msg: str):
    print(Fore.LIGHTBLACK_EX + msg + Style.RESET_ALL, flush=True)
